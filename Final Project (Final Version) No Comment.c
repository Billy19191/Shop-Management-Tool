...
int main()
{
    ...
    file_inventory = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Inventory.txt", "r+");
    file_accounting = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Accounting.txt", "r+");
    file_pos = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/PoS.txt", "a+");
    file_pos2 = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/PoS2.txt", "a+");
    file_timestamp = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Timestamp.txt", "r+");
    file_pos_backup = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/PoSbackup.txt", "w+");
    file_inventory_backup = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Inventorybackup.txt", "w+");
    file_accounting_backup = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Accountingbackup.txt", "w+");
    file_timestamp_backup = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Timestampbackup.txt", "w+");
    file_user = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Username.txt", "r+");
        ...
        while (register_user == 2)
        {
            ...
            else if (select_login == 1)
            {
                while (register_user != 0)
                {
                    ...
                    file_user = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Username.txt", "a+");
...
int menu_inventory(Inventory inventory[], int count, FILE *file_inventory, const char *save_record, const char *import_record)
{
    int num = 0;
    char select = '0';
    char out;
    ...
    while (select != '5')
    {
        ...
        if (select == '1')
        {
            ...
            {
                char name_lower[1000];
                strcpy(name_lower, inventory[i].product_name);
                for (int i = 0; i < strlen(name_lower); i++)
                {
                    name_lower[i] = tolower(name_lower[i]);
                }
                flag = 0;
                if (strcmp(search_name, name_lower) == 0)
                {
                    flag = 1;
                    int quantity, price;
                    char select_1;
        ...
        if (select == '3')
        {
            ...
            char name_lower[1000];
            strcpy(name_lower, inventory[count].product_name);
            for (int i = 0; i < strlen(name_lower); i++)
            {
                name_lower[i] = tolower(name_lower[i]);
            }
            for (int i = 0; i < count; i++)
            {
                char list_lower[1000];
                strcpy(list_lower, inventory[i].product_name);
                for (int j = 0; j < strlen(list_lower); j++)
                {
                    list_lower[j] = tolower(list_lower[j]);
                }
                if (strcmp(name_lower, list_lower) == 0)
                {
                    printf("\U000026D4 Item Already Exist\n");
                    *inventory[count].product_name = '\0';
                    flag_name = 1;
            ...
            if (flag_name == 0)
            {
                printf("\U00002795 Enter Item Quantity : ");
                ...
                printf("\U00002795 Enter Item Minimum Quantity : ");
...
int menu_accounting(Accounting accounting[], Inventory inventory[], Showing acc1[], int count, FILE *file_accounting, FILE *file_timestamp, FILE *file_pos2, FILE *file_pos)
{
    int count_time, count_txn;
    float balance;
    file_accounting = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Accounting.txt", "r+");
    file_pos2 = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/PoS2.txt", "r+");
    file_pos = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/PoS.txt", "r+");
    file_timestamp = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Timestamp.txt", "r+");
    ...
    while (select != 6)
    {
        ...
        else if (select == 2)
        {
            ...
            while (sub_select != 0)
            {
                ...
                const char money_types_str[11][6] = {"1000", "500", "100", "50", "20", "10", "5", "2", "1", "0.5", "0.25"};
        ...
        else if (select == 3)
        {
            ...
            while (select_sub_3 != '0')
            {
                ...
                unsigned long long temp = timestamp_sec() - (timestamp_sec() % 86400000);
        ...
        if (select == 4)
        {
            ...
            {
                float week_profit = 0;
                unsigned long long temp = timestamp_sec() - (timestamp_sec() % (86400000 * 7));
        ...
        if (select == 5)
        {
            ...
            while (select_sub_5 != '0')
            {
                ...
                unsigned long long temp = timestamp_sec() - (timestamp_sec() % (2629743000));
...
int menu_pos(Inventory inventory[], int count, FILE *file_pos, FILE *file_pos2, FILE *file_accounting, FILE *file_timestamp, FILE *file_inventory, FILE *file_pos_backup, FILE *file_inventory_backup, FILE *file_accounting_backup, FILE *file_timestamp_backup)
{
    ...
    do
    {
        ...
        file_timestamp = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Timestamp.txt", "a+");
        ...
        do
        {
            ...
            while (q_count == 0)
            {
                ...
                if (qty <= 0)
                {
                    printf("You can't enter minus quantity");
                    break;
                }
        ...
        do
        {
            ...
            {
                fclose(file_timestamp);
                file_pos = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/PoS.txt", "w");
                file_pos_backup = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/PoSbackup.txt", "r");
                char cpy1;
                ...
                char cpy2;
                file_inventory = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Inventory.txt", "w");
                file_inventory_backup = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Inventorybackup.txt", "r");
                ...
                char cpy3;
                file_timestamp = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Timestamp.txt", "w");
                file_timestamp_backup = fopen("/Users/ratchanon/Desktop/Billy191/CPE100/Final Project/Timestampbackup.txt", "r");
